...
// Embedded standardReconciliation function - FIXED VERSION
...
exports.handler = async (event, context) => {
  ...
  if (event.httpMethod === 'POST') {
    try {
      ...
      // Execute the script based on scriptName
      let result_data;
      
      if (scriptName === 'standardReconciliation') {
        result_data = standardReconciliation(XLSX, file1.content, file2.content);
      } else {
        return {
          statusCode: 404,
          headers,
